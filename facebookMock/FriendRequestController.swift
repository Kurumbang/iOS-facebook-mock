...
class FriendRequestsController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row % 3 == 0 {
            cell.nameLabel.text = "Jessica Smith"
            cell.requestImageView.image = UIImage(named: "jessicaSmith")
        } else if indexPath.row % 3 == 1 {
            cell.nameLabel.text = "Miles Bonn"
            cell.requestImageView.image = UIImage(named: "milesBonn")
        } else {
            cell.nameLabel.text = "Alex Cortney"
            cell.requestImageView.image = UIImage(named: "alexCortney")
        }
